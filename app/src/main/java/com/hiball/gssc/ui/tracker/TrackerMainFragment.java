...
//        requireActivity().getOnBackPressedDispatcher().addCallback(this, callback);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.progressLineHeartRate = view.findViewById(R.id.progressBar_trackerMain_heartRate);
    }
    ...
    public void onResume() {
        ...
        int heartRateCount = SharedActivityData.getHrCount(getContext());

        float heartRatePercentage = (float) heartRateCount / 200;
        this.progressLineHeartRate.setmPercentage((int) (heartRatePercentage * 100));
        this.progressLineHeartRate.setmValueText(heartRateCount);
